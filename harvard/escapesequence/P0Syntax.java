...
public class P0Syntax {
	...
	public static void main(String[] args) {
		...
		// { braces are very important part of program flow such as if,for,while,do-while and switch } 
		// However, squared[] are used to index access elements in arrays,strings and angular<> frequently used in data structures   
		/*
		 * @see oracle doc
		 */
	}
